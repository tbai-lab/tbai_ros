...
#include "tbai_ros_mpc/quadruped_arm_mpc/segmented_planes/SegmentedPlanesSignedDistanceField.h"

namespace tbai::mpc::quadruped_arm {

class SegmentedPlanesTerrainModel : public tbai::mpc::quadruped_arm::TerrainModel {
 public:
  ...
  using tbai::mpc::quadruped_arm::TerrainModel::getConvexTerrainAtPositionInWorld;
