...
RosG1PBHCController::RosG1PBHCController(const std::shared_ptr<tbai::RobotInterface> &robotInterfacePtr,
                                         const std::string &policyPath, const std::string &motionFilePath,
                                         float timeStart, float timeEnd, const std::string &controllerName)
    : G1PBHCController(robotInterfacePtr, policyPath, motionFilePath, timeStart, timeEnd, controllerName) {}
